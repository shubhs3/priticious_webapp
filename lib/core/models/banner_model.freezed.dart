...
mixin _$BannerModel {
 ...
 String get id; String get title; String get subtitle; String get imageUrl; String? get actionRoute; bool get isActive; int get sortOrder;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,title,subtitle,imageUrl,actionRoute,isActive,sortOrder);

@override
String toString() {
  return 'BannerModel(id: $id, title: $title, subtitle: $subtitle, imageUrl: $imageUrl, actionRoute: $actionRoute, isActive: $isActive, sortOrder: $sortOrder)';
}
...
@useResult
$Res call({
 String id, String title, String subtitle, String imageUrl, String? actionRoute, bool isActive, int sortOrder
});
...
/// Create a copy of BannerModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? title = null,Object? subtitle = null,Object? imageUrl = null,Object? actionRoute = freezed,Object? isActive = null,Object? sortOrder = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String title,  String subtitle,  String imageUrl,  String? actionRoute,  bool isActive,  int sortOrder)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _BannerModel() when $default != null:
return $default(_that.id,_that.title,_that.subtitle,_that.imageUrl,_that.actionRoute,_that.isActive,_that.sortOrder);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String title,  String subtitle,  String imageUrl,  String? actionRoute,  bool isActive,  int sortOrder)  $default,) {final _that = this;
switch (_that) {
case _BannerModel():
return $default(_that.id,_that.title,_that.subtitle,_that.imageUrl,_that.actionRoute,_that.isActive,_that.sortOrder);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String title,  String subtitle,  String imageUrl,  String? actionRoute,  bool isActive,  int sortOrder)?  $default,) {final _that = this;
switch (_that) {
case _BannerModel() when $default != null:
return $default(_that.id,_that.title,_that.subtitle,_that.imageUrl,_that.actionRoute,_that.isActive,_that.sortOrder);case _:
  return null;
...
class _BannerModel implements BannerModel {
  const _BannerModel({required this.id, required this.title, required this.subtitle, required this.imageUrl, this.actionRoute, this.isActive = true, this.sortOrder = 0});
...
/// Create a copy of BannerModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? title = null,Object? subtitle = null,Object? imageUrl = null,Object? actionRoute = freezed,Object? isActive = null,Object? sortOrder = null,}) {
